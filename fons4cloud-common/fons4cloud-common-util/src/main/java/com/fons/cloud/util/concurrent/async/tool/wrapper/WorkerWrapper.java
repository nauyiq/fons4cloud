package com.fons.cloud.util.concurrent.async.tool.wrapper;

import cn.hutool.core.date.SystemClock;
import com.fons.cloud.util.concurrent.async.tool.callback.ICallback;
import com.fons.cloud.util.concurrent.async.tool.exeception.SkippedException;
import com.fons.cloud.util.concurrent.async.tool.worker.IWorker;
import com.fons.cloud.util.concurrent.async.tool.worker.ResultState;
import com.fons.cloud.util.concurrent.async.tool.worker.WorkerResult;
