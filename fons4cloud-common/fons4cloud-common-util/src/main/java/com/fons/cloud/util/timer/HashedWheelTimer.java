package com.fons.cloud.util.timer;
...
public class HashedWheelTimer implements Timer {
    ...
    private static final boolean IS_OS_WINDOWS = System.getProperty(StringConstants.OS_NAME_KEY, "").toLowerCase(Locale.US).contains((StringConstants.OS_WIN_PREFIX));
