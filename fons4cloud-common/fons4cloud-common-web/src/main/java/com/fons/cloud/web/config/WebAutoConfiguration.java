package com.fons.cloud.web.config;

import com.fons.cloud.auth.core.AuthorizationResourceRepository;
import com.fons.cloud.web.filter.AuthUserFilter;
import com.fons.cloud.web.filter.TokenFilter;
import com.fons.cloud.web.support.HttpAuthenticationResourceScanner;
