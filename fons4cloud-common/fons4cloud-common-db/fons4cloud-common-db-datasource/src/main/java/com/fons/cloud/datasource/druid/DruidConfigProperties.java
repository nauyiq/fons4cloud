package com.fons.cloud.datasource.druid;

import cn.hutool.core.map.MapUtil;
import com.alibaba.druid.pool.DruidDataSource;
import com.alibaba.druid.pool.DruidDataSourceFactory;
import com.fons.cloud.datasource.druid.filter.StatFilterConfig;
...
public class DruidConfigProperties implements StatFilterConfig {

    private int initialSize = 0;
    private int minIdle = 10;
    private int maxActive = 50;
    private int maxWait = 2000;
    private long slowSqlMillis = 2500;
    ...
    public Map<String, String> toMap() {
        ...
        map.put(DruidDataSourceFactory.PROP_TIMEBETWEENEVICTIONRUNSMILLIS, timeBetweenEvictionRunsMillis + "");
