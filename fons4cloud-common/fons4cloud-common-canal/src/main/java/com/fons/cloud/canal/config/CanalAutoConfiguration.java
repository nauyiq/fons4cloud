package com.fons.cloud.canal.config;

import com.fons.cloud.canal.core.CanalGlue;
import com.fons.cloud.canal.core.DefaultCanalBinlogEventProcessorFactory;
import com.fons.cloud.canal.core.DefaultCanalGlue;
import com.fons.cloud.canal.core.parser.BaseParseResultInterceptor;
import com.fons.cloud.canal.core.parser.CanalBinLogEventParser;
import com.fons.cloud.canal.core.parser.ModelTableMetadataManager;
import com.fons.cloud.canal.core.parser.ParseResultInterceptorManager;
import com.fons.cloud.canal.core.parser.converter.CanalFieldConverterFactory;
import com.fons.cloud.canal.core.parser.converter.support.InMemoryCanalFieldConverterFactory;
import com.fons.cloud.canal.core.parser.support.DefaultCanalBinLogEventParser;
import com.fons.cloud.canal.core.parser.support.InMemoryModelTableMetadataManager;
import com.fons.cloud.canal.core.parser.support.InMemoryParseResultInterceptorManager;
import com.fons.cloud.canal.core.processor.BaseCanalBinlogEventProcessor;
import com.fons.cloud.canal.core.processor.CanalBinlogEventProcessorFactory;
