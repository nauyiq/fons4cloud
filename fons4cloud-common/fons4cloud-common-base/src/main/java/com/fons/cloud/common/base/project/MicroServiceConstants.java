package com.fons.cloud.common.base.project;
...
public class MicroServiceConstants {
     ...
     * 后台管理服务
     */
    public static final String ADMIN_SERVICE = "fons4cloud-auth-admin-service";
     ...
     * 聊天消息服务
     */
    public static final String MESSAGE_NETTY_SERVICE = "fons4cloud-apps-message-service";
    public static final ProjectInfo MESSAGE_NETTY_INFO = new ProjectInfo("聊天消息服务", MESSAGE_NETTY_SERVICE);

    /**
     * 博客服务.
     */
    public static final String BLOG_SERVICE = "fons4cloud-apps-blog-service";
