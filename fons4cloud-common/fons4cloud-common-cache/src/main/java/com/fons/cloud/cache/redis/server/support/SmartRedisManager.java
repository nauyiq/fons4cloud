package com.fons.cloud.cache.redis.server.support;

import cn.hutool.extra.spring.SpringUtil;
import com.fons.cloud.cache.common.RedisException;
import com.fons.cloud.common.base.lang.StringConstants;
import com.fons.cloud.cache.redis.server.AbstractTemplateOperations;
import com.fons.cloud.cache.redis.server.RedisStringTemplateOperations;
...
public class SmartRedisManager extends AbstractTemplateOperations implements RedisStringTemplateOperations {
    private static final Logger log = LoggerFactory.getLogger(SmartRedisManager.class);
