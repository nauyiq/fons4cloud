package com.fons.cloud.cache.redis.server;
...
/**
 * redis object类型操作service, 基于RedisTemplate
 * @author qiyuan.hong
 * @version 1.0
 * @date 2024/6/18
 */
public interface RedisObjectTemplateOperations extends RedisTemplateOperations {
