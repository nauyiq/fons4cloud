package com.fons.cloud.mq.rabbit.config;

import com.fons.cloud.canal.core.CanalGlue;
import com.fons.cloud.mq.api.transactional.service.MqMessageOperations;
import com.fons.cloud.mq.api.transactional.service.MqTransactionalService;
import com.fons.cloud.mq.rabbit.canal.RabbitCanalListener;
import com.fons.cloud.mq.rabbit.dynamic.RabbitModuleInitializer;
import com.fons.cloud.mq.rabbit.dynamic.RabbitModuleProperties;
import com.fons.cloud.mq.rabbit.server.RabbitProducerFactory;
import com.fons.cloud.mq.rabbit.server.RabbitTransactionalService;
import com.fons.cloud.mq.rabbit.server.RabbitmqProducer;
