 ...
 *      spring.kafka.producer.properties.partitioner.class=com.fons.mq.kafka.server.CustomerKafkaPartitioner
 ...
 */
public class CustomerKafkaPartitioner implements Partitioner {
