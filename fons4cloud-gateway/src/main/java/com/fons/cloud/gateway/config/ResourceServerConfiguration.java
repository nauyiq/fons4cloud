...
import com.fons.cloud.gateway.filter.SecurityAuthenticationFilter;
import com.fons.cloud.gateway.server.auth.AuthorizationManager;
import com.fons.cloud.gateway.server.auth.ClientSecretReactiveAuthenticationManager;
