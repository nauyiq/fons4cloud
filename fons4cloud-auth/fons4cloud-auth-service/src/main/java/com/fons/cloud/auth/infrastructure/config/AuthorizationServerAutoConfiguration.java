package com.fons.cloud.auth.infrastructure.config;

import com.fons.cloud.auth.common.SecurityConstants;
import com.fons.cloud.auth.security.core.RedisOAuth2AuthorizationService;
import com.fons.cloud.auth.oauth.core.DefaultDaoAuthenticationProvider;
import com.fons.cloud.auth.oauth.core.DefaultOauth2TokenCustomizer;
import com.fons.cloud.auth.oauth.core.FormIdentityLoginConfigurer;
import com.fons.cloud.auth.oauth.core.RedisOAuth2AuthorizationConsentService;
import com.fons.cloud.auth.oauth.core.email.Oauth2ResourceOwnerEmailAuthenticationConverter;
import com.fons.cloud.auth.oauth.core.email.Oauth2ResourceOwnerEmailAuthenticationProvider;
import com.fons.cloud.auth.oauth.core.password.Oauth2ResourceOwnerPasswordAuthenticationConverter;
import com.fons.cloud.auth.oauth.core.password.Oauth2ResourceOwnerPasswordAuthenticationProvider;
import com.fons.cloud.auth.oauth.core.sms.Oauth2ResourceOwnerSmsAuthenticationConverter;
import com.fons.cloud.auth.oauth.core.sms.Oauth2ResourceOwnerSmsAuthenticationProvider;
import com.fons.cloud.auth.oauth.handler.DefaultAuthenticationFailureHandler;
import com.fons.cloud.auth.oauth.handler.DefaultAuthenticationSuccessHandler;
import com.fons.cloud.auth.oauth.server.DefaultOauth2AccessTokenGenerator;
